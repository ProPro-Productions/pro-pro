...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: YMVJUwUaKqUA/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: razNr1MlG8g-/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: N20p8KRGtE_5/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__hlvoA)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__qgwG3)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__wkdMe)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__pjMhB)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__fhB6C)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
